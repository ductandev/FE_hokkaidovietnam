...
export default function Profile() {
  ...
  const changeProfileFrm = useFormik<UserProfileFrm>({
    initialValues: {
      ...
      phuong_id: user?.phuong_id || "",
      quan_id: user?.quan_id || "",
          ...
          <form onSubmit={changeProfileFrm.handleSubmit}>
            <div className="flex flex-col">
              ...
              <input
                ...
                value={changeProfileFrm.values.nguoi_dung_id}
              />
                ...
                <div>
                  <Controller
                    ...
                    render={({ field }: any) => {
                      return (
                        <input
                          value={field.value}  //changeProfileFrm.values để hiển thị dữ liệu lên ô input.
                  ...
                  {/* VALIDATION NAME */}
                  {changeProfileFrm.errors.ho_ten && (
              ...
              {isEditingPassword ? (
                <div>
                  <input
                    ...
                    onInput={changeProfileFrm.handleChange}
                    onBlur={changeProfileFrm.handleChange}
                    value={changeProfileFrm.values.mat_khau}
                    className="border-2 border-gray-300 w-full rounded p-3"
                    placeholder='Nhập để thay đổi mật khẩu'
                  />
                  {/* VALIDATION NAME */}
                  {changeProfileFrm.errors.mat_khau && (
                    <p className="text-rose-500 text-sm">
                      <span className="flex items-center">
                        <RiErrorWarningFill /> &nbsp;
                        {changeProfileFrm.errors.mat_khau}
              ...
              <div className="flex flex-row items-start justify-between mt-6">
                ...
                <div>
                  {isEditingAddress ? (
                    <button type="button" className="text-black font-bold underline" onClick={handleCancelAddress}>Hủy</button>
                  ) : (
                    <button type="button" className="text-black font-bold underline" onClick={handleEditAddress}>Chỉnh sửa</button>
                  )}
                </div>
              </div>
              {isEditingAddress ? (
                <div>
                  <input
                    ...
                    onInput={changeProfileFrm.handleChange}
                    onBlur={changeProfileFrm.handleChange}
                    value={changeProfileFrm.values.dia_chi}
                    className="border-2 border-gray-300 w-full rounded px-3 py-2"
                  />
                  {/* VALIDATION NAME */}
                  {changeProfileFrm.errors.dia_chi && (
                    <p className="text-rose-500 text-sm">
                      <span className="flex items-center">
                        <RiErrorWarningFill /> &nbsp;
                        {changeProfileFrm.errors.dia_chi}
                  ...
                  <Controller
                    ...
                    render={({ field }: any) => {
                      return (
                        <div className="mt-4" >
                          <Selection
                            className='border-2 border-gray-300 w-full rounded !text-base p-3'
                            title="Tỉnh thành"
              ...
              {isEditingGender ? (
                <div>
                  <p className="text-sm text-gray-500">Sửa lại giới tính của bạn</p>
                  <div className="rounded-md border-2 border-gray-300 p-3 text-base">
                    <select
                      id="gioi_tinh"
                      name="gioi_tinh"
                      onInput={changeProfileFrm.handleChange}
                      onBlur={changeProfileFrm.handleChange}
                      value={changeProfileFrm.values.gioi_tinh.toString()}
                      className="w-full outline-none">
                      <option className='text-lg rounded-lg' value="true">Nam</option>
                      <option className='text-lg rounded-lg' value="false">Nữ</option>
                    </select>
                  </div>

                  {/* VALIDATION NAME */}
                  {changeProfileFrm.errors.gioi_tinh && (
                    <p className="text-rose-500 text-sm">
                      <span className="flex items-center">
                        <RiErrorWarningFill /> &nbsp;
                        {changeProfileFrm.errors.gioi_tinh}
