...
// * container style
const configSizeContent = {
  width: "w-[90vw] sm:w-[70vw] md:w-[820px]",
  height: "",
  boxSizing: "p-0 md:p-6 "
};

// * body style
const configSizeDescription = {
  width: "max-h-[70vh] md:max-h-full",
  height: "",
  boxSizing: "p-6 md-p-0 "
};
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        `
        ${configSizeContent.boxSizing} 
        ${configSizeContent.width} 
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn(`
    ${configSizeDescription.width}
    ${configSizeDescription.boxSizing}
    overflow-auto text-sm text-muted-foreground`, className)}
    {...props}
  />
))
