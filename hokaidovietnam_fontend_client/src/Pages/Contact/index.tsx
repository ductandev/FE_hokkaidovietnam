                            ...
                            <form onSubmit={contactFrm.handleSubmit}>
                                <div className="relative">
                                    ...
                                    {contactFrm.errors.name && (
                                        <p className="text-rose-500 text-[9px] sm:text-sm indent-3 sm:indent-5 absolute bottom-0">{contactFrm.errors.name}</p>
                                    )}
                                </div>
                                <div className="relative">
                                    <Input
                                    ...
                                    {contactFrm.errors.email && (
                                        <p className="text-rose-500 text-[9px] sm:text-sm indent-3 sm:indent-5 absolute bottom-0">{contactFrm.errors.email}</p>
                                    )}
                                </div>
                                <textarea
                                    id="contentContact"
